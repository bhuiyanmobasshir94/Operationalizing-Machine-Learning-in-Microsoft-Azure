...
ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer tfX2i8Mzy9FMWs7UbVBQG33HzhnYDmCL' http://0323381c-b479-4925-a05a-1ae566dd0605.southcentralus.azurecontainer.io/score
